#ifndef HAMMING_ONE_CPU_HPP
#define HAMMING_ONE_CPU_HPP
 ...
 * the precomputed hash values. It outputs the indices of sequence pairs that 
 * have exactly one bit difference.
 * 
 * Architecture: CPU
 * Complexity: O(L * MlogM)
 * 
